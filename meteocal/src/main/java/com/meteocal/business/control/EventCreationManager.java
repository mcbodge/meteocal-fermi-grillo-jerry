...
public class EventCreationManager {
     ...
     * minute).
     * @param location the location of the event, generated or given by the
     * user, or null.
    ...
    /**
     * NEW EVENT, GIVING THE LOCATION ID The name of the location is
     * automatically generated*** Creates a new event, given the required
     * parameters and returns its id. Requires valid creator, name, start and
     * end.
     *
     ...
     * @param end the end datetime of the event (w/ year, month, day, hour and
     * minute).
     * @param geoname the generated location of the event (if it's null no Event
     * is created).
     * @param invited the list of the users invited to the event, or null.
     * @param p the privacy value 0 for public, 1 for private.
     * @param constraint the generated constraint value of the event, or null.
     ...
     */
    /*
    public Event newEvent(User creator, String name, Date start, Date end, Integer geoname, List<User> invited, boolean p, Integer constraint, String description, int numOverlappingEvents) {
