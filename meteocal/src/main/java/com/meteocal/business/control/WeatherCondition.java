...
//</editor-fold>
    ...
    this.value=OpenWeatherMapController.getValueFromCode(code);
    
    }
    
    public Condition convertForecast(Integer code){
    return OpenWeatherMapController.getValueFromCode(code);
    }*/
